...
public class PublishCommentAdaptee implements IMessageAdaptee {
    ...
    public FishMessage initMessage(Object object) {
        ...
        String content = HTMLUtil.aFont(userUrl,fishComments.getFromUserName() , H5ColorConst.SKY_BLUE)+"对您进行了评论:"+ HTMLUtil.aFont(commentUrl,fishComments.getArticleComment() , H5ColorConst.SKY_BLUE);
