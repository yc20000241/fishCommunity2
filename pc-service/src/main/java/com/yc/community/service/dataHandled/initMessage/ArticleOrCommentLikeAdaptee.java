...
public class ArticleOrCommentLikeAdaptee implements IMessageAdaptee {
    ...
    public FishMessage initMessage(Object object) {
        ...
        if(object instanceof HashMap){
            ...
            if(obj instanceof FishArticles){
        ...
        }else if(object instanceof FishComments){
            ...
            String content = fishComments.getFromUserName() + "对你进行评论："+ fishComments.getArticleComment();
            fishMessage.setContent(content);
        }
